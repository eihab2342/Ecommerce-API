...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='517'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='853'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-3 .hljs-ln-line[data-line-number='118'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-4 .hljs-ln-line[data-line-number='105'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-5 .hljs-ln-line[data-line-number='88'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-6 .hljs-ln-line[data-line-number='62'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-7 .hljs-ln-line[data-line-number='209'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-8 .hljs-ln-line[data-line-number='25'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-10 .hljs-ln-line[data-line-number='127'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-11 .hljs-ln-line[data-line-number='24'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-13 .hljs-ln-line[data-line-number='127'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-18 .hljs-ln-line[data-line-number='201'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-19 .hljs-ln-line[data-line-number='170'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-28 .hljs-ln-line[data-line-number='110'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-30 .hljs-ln-line[data-line-number='62'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-36 .hljs-ln-line[data-line-number='127'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-37 .hljs-ln-line[data-line-number='176'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-38 .hljs-ln-line[data-line-number='145'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-39 .hljs-ln-line[data-line-number='1220'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-40 .hljs-ln-line[data-line-number='20'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-41 .hljs-ln-line[data-line-number='23'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
    </style>
</head>

<body class="bg-gray-200/80 font-sans antialiased">
    <div class="renderer container mx-auto lg:px-8">
                    ...
                    <div class="flex items-center">
                        <div class="rounded-full bg-red-500/20 p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="h-6 w-6 fill-red-500 text-gray-50">
        ...
        systemMode() {
            ...
            setDarkClass()
                            ...
                            <button
        x-cloak
        class="block rounded p-1 hover:bg-gray-100"
        :class="theme ? 'text-gray-700' : 'text-gray-400 hover:text-gray-500 focus:text-gray-500'"
        @click="menu = ! menu"
    >
        <svg
...
>
    <path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
                            ...
                            <div x-show="menu"
                                class="absolute right-0 z-10 flex origin-top-right flex-col rounded-md bg-white shadow-xl ring-1 ring-gray-900/5"
                                style="display: none" @click="menu = false">
                                <button
            class="flex items-center gap-3 px-4 py-2 hover:rounded-t-md hover:bg-gray-100"
            :class="theme === 'light' ? 'text-gray-900' : 'text-gray-500'"
            @click="lightMode()"
        >
            <svg
    xmlns="http://www.w3.org/2000/svg"
...
>
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
            ...
            :class="theme === 'dark' ? 'text-gray-900' : 'text-gray-500'"
            @click="darkMode()"
        >
            <svg
    xmlns="http://www.w3.org/2000/svg"
...
>
    <path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
            ...
            Dark
                                ...
                                <button
            class="flex items-center gap-3 px-4 py-2 hover:rounded-b-md hover:bg-gray-100"
            :class="theme === undefined ? 'text-gray-900' : 'text-gray-500'"
            @click="systemMode()"
        >
            <svg
    xmlns="http://www.w3.org/2000/svg"
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" />
        ...
        <main class="px-6 pb-12 pt-6">
            <div class="container mx-auto">
                <section
                    class="@container flex flex-col p-6 sm:p-12 bg-white text-gray-900 rounded-lg default:col-span-full default:lg:col-span-6 default:row-span-1 shadow-xl">
                    <div class="md:flex md:items-center md:justify-between md:gap-2">
                        <div class="min-w-0">
                            <div
                                class="inline-block rounded-full bg-red-500/20 px-3 py-2 max-w-full text-sm font-bold leading-5 text-red-500 truncate lg:text-base">
                    ...
                    RouteNotFoundException
                            ...
                            <div
                                class="mt-4 text-lg font-semibold text-gray-900 break-words lg:text-2xl">
                    ...
                    PUT 127.0.0.1:8000
                            ...
                            <div class="px-4">
                                <span class="text-sm text-gray-500">PHP 8.4.3 — Laravel 11.44.2</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section
                    class="@container flex flex-col p-6 sm:p-12 bg-white text-gray-900 rounded-lg default:col-span-full default:lg:col-span-6 default:row-span-1 shadow-xl mt-6 overflow-x-auto">
                    <div x-data="{
            ...
            index: 0,
                        ...
                        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3" x-clock>
                            <div class="hidden overflow-x-auto sm:col-span-1 lg:block">
                                <div
                                    class="h-[35.5rem] scrollbar-hidden trace text-sm text-gray-400">
                                    <div
                                        class="mb-2 inline-block rounded-full bg-red-500/20 px-3 py-2 sm:col-span-1">
                                        <button
    ...
    <path fill-rule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" />
                ...
                >
                    <div
                        x-bind:class="
                            index === 0
                                ? 'rounded-r-md bg-gray-100 border-l border-l-red-500'
                                : 'hover:bg-gray-100/75'
                        "
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Routing\UrlGenerator</span>
                                    <span class="font-mono text-xs">:517</span>
                                </span>
                            </div>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\helpers.php</span>
                                    <span class="font-mono text-xs">:853</span>
                                </span>
                            </div>
                            <div class="text-gray-500">
                                route
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Configuration\ApplicationBuilder</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Auth\Middleware\Authenticate</span>
                                    <span class="font-mono text-xs">:118</span>
                                </span>
                            </div>
                            <div class="text-gray-500">
                                redirectTo
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Auth\Middleware\Authenticate</span>
                                    <span class="font-mono text-xs">:105</span>
                                </span>
                            </div>
                            <div class="text-gray-500">
                                unauthenticated
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Pipeline\Pipeline</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful</span>
                                    <span class="font-mono text-xs">:25</span>
                                </span>
                            </div>
                            <div class="text-gray-500">
                                {closure:Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful::handle():24}
                            </div>
                        </div>
                    </div>
                </button>
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful</span>
                                    <span class="font-mono text-xs">:24</span>
                                </span>
                            </div>
                            <div class="text-gray-500">
                                handle
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Routing\Router</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Http\Kernel</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Http\Middleware\TransformsRequest</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Http\Middleware\TrimStrings</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Http\Middleware\ValidatePostSize</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Http\Middleware\PreventRequestsDuringMaintenance</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Http\Middleware\HandleCors</span>
                                    <span class="font-mono text-xs">:62</span>
                                </span>
                            </div>
                            <div class="text-gray-500">
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Http\Middleware\TrustProxies</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Http\Middleware\InvokeDeferredCallbacks</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">Illuminate\Foundation\Application</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">F:\API-JWT\public\index.php</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\resources\server.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Routing\UrlGenerator.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\helpers.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Configuration\ApplicationBuilder.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Auth\Middleware\Authenticate.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Pipeline\Pipeline.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\sanctum\src\Http\Middleware\EnsureFrontendRequestsAreStateful.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Routing\Router.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Http\Kernel.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\TransformsRequest.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\TrimStrings.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Http\Middleware\ValidatePostSize.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\PreventRequestsDuringMaintenance.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Http\Middleware\HandleCors.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Http\Middleware\TrustProxies.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\InvokeDeferredCallbacks.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\Application.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\public\index.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900">F:\API-JWT\vendor\laravel\framework\src\Illuminate\Foundation\resources\server.php</span>
...
require_once $publicPath.&#039;/index.php&#039;;
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>PUT</span>
                        <span class="text-gray-500">/api/profile</span>
                    </div>
                    ...
                    <dl class="mt-1 grid grid-cols-1 rounded border">
                        <div class="flex items-center gap-2 ">
                            <span
                    data-tippy-content="authorization"
                    class="lg:text-md w-[8rem] flex-none cursor-pointer truncate border-r px-5 py-3 text-sm lg:w-[12rem]"
                >
                    authorization
                </span>
                            <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">Bearer 7185c17165268648899a12238a174e1e169c3ff9dc1c3c2e2600a3d78a0d6da2</code></pre>
                </span>
                        </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">2c02ce2e-5b7e-4f9f-b110-331e3d876244</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">102</code></pre>
                </span>
                        </div>
                    </dl>

                    <div class="mt-4">
                        <span class="font-semibold text-gray-900">Body</span>
                    </div>
    ...
    &quot;password&quot;: &quot;newsecret123&quot;
                ...
                <section
                    ...
                    <div class="mt-4">
                        <span class="font-semibold text-gray-900"> Routing </span>
                    </div>
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">\App\Http\Controllers\UserController@updateProfile</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t">
                            <span
                ...
                >
                    ...
                    <div class="mt-4">
                        <span class="font-semibold text-gray-900"> Database Queries </span>
                    ...
                    <dl class="mt-1 grid grid-cols-1 rounded border">
                        <div class="flex items-center gap-2 ">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(22.1 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `personal_access_tokens` where `token` = &#039;e55bce0bf4091553cda231cfb298da3cd38dc33ed84bad92824ca099c9faaf2c&#039; limit 1</code></pre>
                </span>
                        </div>
                    </dl>
                </section>
